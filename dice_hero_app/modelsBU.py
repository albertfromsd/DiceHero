...
class User(models.Model):
    ...
    def __repr__(self):
        return '\n'.join([f"----------", f"[ID #{self.id}]", f"[Username: {self.name}]", f"[Email: {self.email}]", "***********", f"[[Heroes: {self.heroes.all()}]]", "----------"])
...
class Hero(models.Model):
    ...
    gems = models.IntegerField(MaxValueValidator(999999), default=100)
    #base stats
    ...
    def __repr__(self):
        return '\n'.join([f"----------", f"[ID #{self.id}]", f"[Hero: {self.name}]", f"[Level: {self.level}]", f"[User: {self.user}]", f"[HP: {self.hp_base}]", f"[ATK: {self.atk_base}]", f"[DEF: {self.def_base}]", f"[INT: {self.int_base}]", f"[SPD: {self.spd_base}]", "**********", f"[Weapons: {self.weapons.all()}]",  f"[Armor: {self.armors.all()}]""----------"])
...
class Weapon(models.Model):
    ...
    def __repr__(self):
        return '\n'.join([f"----------", f"[ID #{self.id}][Weapon: {self.name}][Price: {self.price}]", f"[ATK: {self.atk_boost}][DEF: {self.def_boost}][INT: {self.int_boost}][SPD: {self.spd_boost}][# of slots: {self.slots}]", "***********", f"[WpnDice: {self.wpn_dice.all()}]", "----------"])
...
class WpnDice(models.Model):
    ...
    def __repr__(self):
        return '\n'.join([f"----------", f"[ID #{self.id}][WpnDice: {self.name}][Price: {self.price}][Parent: {self.parent}]", "***********", f"[WpnDfaces: {self.wpn_dfaces.all()}]", "----------"])
...
class Armor(models.Model):
    ...
    def __repr__(self):
        return '\n'.join([f"----------", f"[ID #{self.id}][Armor: {self.name}][Owner: {self.owner}][Price: {self.price}]", f"[ATK: {self.atk_boost}][DEF: {self.def_boost}][INT: {self.int_boost}][SPD: {self.spd_boost}][# of slots: {self.slots}]", "**********", f"[Dice: {self.armor_dice.all()}]", "----------"])
...
class ArmorDice(models.Model):
    ...
    def __repr__(self):
        return '\n'.join([f"----------", f"[ID #{self.id}][ArmorDice: {self.name}][Price: {self.price}]", f"[Owner: {self.owner}][Parent: {self.parent}]", "**********", f"[Dfaces: {self.armor_dfaces.all()}]", "----------"])
...
class Enemy(models.Model):
    ...
    s5 = models.IntegerField(MaxValueValidator(99), default=1)
